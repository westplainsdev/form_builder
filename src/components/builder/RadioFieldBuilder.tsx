...
import OptionsEditor, { OptionItem } from '../OptionsEditor';

interface RadioFieldBuilderProps {
  field: FormField;
  index: number;
...
const RadioFieldBuilder: React.FC<RadioFieldBuilderProps> = ({ field, index, updateField }) => {
  return (
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-2">
          <OptionsEditor
            ...
            onChange={opts => updateField(index, { ...field, options: opts })}
          />
        </div>
