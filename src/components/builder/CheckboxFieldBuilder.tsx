...
const CheckboxFieldBuilder: React.FC<CheckboxFieldBuilderProps> = ({ field, index, updateField }) => {
  return (
        ...
        <div className="col-span-2 flex items-center space-x-4">
          ...
          <label className="flex items-center ml-6">
            <input
              ...
              onChange={e => updateField(index, { ...field, defaultValue: e.target.checked })}
              className="rounded border-theme-border text-blue-600"
            />
            <span className="ml-2 text-sm text-theme-text-secondary">Default Value</span>
          </label>
        </div>
      </div>
    </div>
